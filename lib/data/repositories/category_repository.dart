...
class CategoryRepositoryImpl implements CategoryRepository {
  ...
  Future<List<CategoryModel>> getCategories() async {
    final response = await _httpClient.get(ADAPIs.categoriesR);
  ...
  Future<CategoryModel?> getCategory(int categoryId) async {
    final response = await _httpClient.get(ADAPIs.categoryR);
  ...
  Future<void> createCategory(CategoryModel category) async {
    ...
    await _httpClient.post(ADAPIs.categoryC, category.toJson());
  }

  @override
  Future<void> updateCategory(CategoryModel category) async {
    // Send update Category request to API
    await _httpClient.put(ADAPIs.categoryU + category.id.toString(), category.toJson());
  }

  @override
  Future<void> deleteCategory(int categoryId) async {
    // Send delete Category request to API
    await _httpClient.delete(ADAPIs.categoryD + categoryId.toString());
  }
}
